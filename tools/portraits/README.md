...
Use the existing [Windows development environment](../../docs/development/WINDOWS-DEV-SETUP.md):
MSVC x64 and the project's installed OGRE/CEGUI libraries, render plugins, codecs
